    ...
    products: [
      {
        ...
        description:
          'In keeping with MacDon’s tradition of pioneering new technologies, our self-propelled mowers will give you the highest performance in your conditions simply by choosing the right header: draper, rotary disc or auger. With patented Dual Direction® technology, the mower can move across the field at speeds up to 26 km/h and on the road at speeds up to 37 km/h. The comfort and reliability of the machine will allow the operator to mow all day, year after year.',
      },
      {
        srcProduct: '/p1_2.png',
        title: 'MacDon FD2 Series FlexDraper',
        description:
          'The FD2 is the evolution of the world’s first flexible draper header for combines, which MacDon introduced 20 years ago. An exceptionally well-designed header, the FD2’s strengths lie with it’s ground following ability, speed of cutting, high capacity heads-first crop feeding, and ease of adjustment.',
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        description:
          'What initially started as a rock roller has evolved into a multi-use and valuable farm asset. Landrollers smooth the field surface by pushing down rocks and debris, allowing the cutter bar to operate effectively and reduce the risk of repairs. Create better germination with optimal soil-to-seed contact. Increase yields on your farm with a Mandako Landroller!',
      },
    ],
  },
];
